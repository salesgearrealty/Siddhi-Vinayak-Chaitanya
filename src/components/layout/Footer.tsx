  ...
  return (
    <footer className="w-full bg-black pt-24 pb-12 overflow-hidden border-t border-white/5">
      <div className="container mx-auto px-6">
        ...
        {/* Essential Compliance - Exemption Disclosure */}
        ...
        <div className="pt-12 border-t border-white/5 flex flex-col md:flex-row justify-between items-center gap-6">
          <p className="text-white/10 text-[8px] uppercase tracking-[0.2em]">© 2026 SIDDHI VINAYAK DEVELOPERS. All Rights Reserved.</p>
