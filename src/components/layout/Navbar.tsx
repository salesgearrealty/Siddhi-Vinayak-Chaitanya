    ...
    <>
      ...
      >
        <div className="container mx-auto px-6 flex items-center justify-between">
          ...
          <Link href="/#hero" className="flex items-center gap-4 group">
            <div className="relative w-12 h-12 md:w-14 md:h-14 overflow-hidden rounded-md border border-white/10 group-hover:border-[#C5A059]/40 transition-colors duration-300">
              <Image
                src="/Logoo.avif"
                alt="SiddhiVinayak Chaitanya Logo"
                fill
                priority
            ...
            <div className="text-white font-serif text-2xl md:text-3xl tracking-tight flex flex-col leading-none">
          ...
          <div className="hidden md:flex items-center gap-10 ml-auto">
            ...
            >
              ...
              <span className="text-[13px] tracking-wider font-black whitespace-nowrap">
                {phoneNumber}
              </span>
            </a>
      ...
      <div className="md:hidden fixed bottom-0 left-0 w-full z-[100] px-4 pb-6 pt-2 bg-gradient-to-t from-black via-black/90 to-transparent">
        <div className="bg-[#111]/95 backdrop-blur-2xl border border-white/15 rounded-2xl flex items-center justify-around py-3.5 px-3 shadow-[0_-10px_40px_rgba(0,0,0,0.6)]">
          ...
          {/* MOBILE CTA */}
          <button onClick={onCTA} className="flex flex-col items-center gap-1.5">
            ...
            <span className="text-[9px] uppercase tracking-[0.15em] font-black text-[#C5A059]">
              Connect
            </span>
          </button>
